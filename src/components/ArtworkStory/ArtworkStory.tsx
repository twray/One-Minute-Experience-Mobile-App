...
> {
  ...
  //       <ImageBackground
  //         source={{ uri: this.props.imageUrl }}
  //         style={{ flex: 2, borderBottomLeftRadius:5, borderBottomRightRadius:5 }}
  ...
  // private renderTitle() {
  //   return (
  //   <View style={{ flex:1, alignItems: 'center', paddingTop: 45, paddingBottom: 20 }}>
  //     <View style={{ flex:3 }}>
  //       <Text style={{ fontSize:21, textAlign:'center', textTransform:'uppercase' }}>
  //         <Text style={{ fontWeight: 'bold', alignItems: 'center' }}>
  //           {this.props.title}
  //         </Text>
  //         <Text>{' '}</Text>
  ...
  //         </Text>
  //       </Text>
  //       <Text style={{ textAlign:'center', marginTop:10, fontSize: 19 }}>
  //         {this.props.artistName}, {this.props.artistNationality}
  //       </Text>
  //     </View>
  //     <View
  ...
  private getOpacityOfBackgroundImage(): number {
    if (this.state.activeSegmentIndex === 0) return 0.0;
    return 1.0;
  }
}
